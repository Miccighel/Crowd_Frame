...
export class JustificationFieldComponent implements OnInit, OnDestroy, OnChanges {
  ...
  ngOnInit(): void { this.bindValueChanges(); }
  ...
  showRequiredError(): boolean   { return this.shouldShow() && !!this.ctrl()?.hasError('required'); }
  showLongerError(): boolean     { return this.shouldShow() && !!this.ctrl()?.hasError('longer'); }
  showInvalidUrlError(): boolean { return this.shouldShow() && !!this.ctrl()?.hasError('invalid'); }
